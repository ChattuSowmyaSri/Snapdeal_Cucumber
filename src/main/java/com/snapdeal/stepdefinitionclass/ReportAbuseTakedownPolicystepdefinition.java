...
import com.snapdeal.pom.ReportAbuseTakedownPolicyPom;
...
public class ReportAbuseTakedownPolicystepdefinition extends BaseClass {
	...
	ReportAbuseTakedownPolicyPom t = new ReportAbuseTakedownPolicyPom(driver);
	...
	public void user_click_on_ReportAbuseTakedownPolicy() {
		t.reprotabuse();
	}
